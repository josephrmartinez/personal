---
title: "Implement Semantic Search using Datasette"
description: "Spinning up 'vibe-search' on a SQLite Database."
...
Make the update to the custom query and save your metadata file. For reference, your metadata.json file should now look like this demo [metadata.json](https://github.com/josephrmartinez/recipe-dataset/blob/main/metadata.json) file.
